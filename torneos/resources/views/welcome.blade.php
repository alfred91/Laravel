            ...
            <div class="mt-16">
                <a href="{{ route('dashboard') }}"
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Torneos</h2>

                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            Aquí puedes encontrar información sobre nuestros torneos y competencias. ¡Participa y
                            demuestra tus habilidades en nuestros emocionantes eventos!
                        </p>
                    </div>
